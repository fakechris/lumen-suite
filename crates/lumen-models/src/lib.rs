...
pub use paths::{
    ...
    paraformer_tokens_path, qwen_ready, scan_model_candidates, scan_model_candidates_with_root,
    sensevoice_model_path, sensevoice_ready, sensevoice_tokens_path, shared_paraformer_offline_dir,
